  ...
  <div id="group-buy">
    ...
    >
      <li v-for="(goods, index) in assemble" :key="index" class="item-goods">
        <dt>
	        <a v-if="!goods.is_enable_sale" href="javascript:void(0);">
		        <img :src="goods.thumbnail" :alt="goods.goods_name">
	        </a>
          <a v-else :href=" `/goods/${goods.goods_id}?sku_id=${goods.sku_id}&pintuan_id=${goods.pin_tuan_id}&from_nav=assemble`">
            <img :src="goods.thumbnail" :alt="goods.goods_name">
          </a>
        </dt>
        <dd>
          ...
          <div class="descrip-goods">
            ...
            <a v-if="!goods.is_enable_sale" href="javascript:void(0);" class="grab-btn">已售空</a>
            <a v-else :href="`/goods/${goods.goods_id}?sku_id=${goods.sku_id}&pintuan_id=${goods.pin_tuan_id}&from_nav=assemble`" class="grab-btn">去开团</a>
          </div>
        </dd>
      </li>
    </van-list>
