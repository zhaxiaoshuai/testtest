    ...
    <div v-else class="checkout-container">
      ...
      <van-cell-group>
        ...
        <van-cell title="发票信息" is-link @click="showReceiptPopup = true" class="remark-cell">
          <span v-if="!params.receipt || !params.receipt.receipt_title">不开发票</span>
    ...
    methods: {
      ...
      GET_Inventories() {
        Promise.all([
          ...
          let coupon_num = 0
          cart_list.forEach(shop => { coupon_num += shop.coupon_list.filter(coupon => coupon.enable !== 0).length })
