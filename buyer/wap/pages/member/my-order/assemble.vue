      ...
      <div class="assemble-invitations">
        ...
        <ul>
          <li v-for="(user, index) in assemble.participants" :key="index">
            <img v-if="user.face" :src="user.face" alt="">
        ...
        <div class="invite-friends">
	        <!--未成团 - 被分享-->
          <button v-if="assemble.left_time && isShared && isFinshed" @click="showSpecsPopup = true">我也要参团</button>
          <!--未成团 - 未被分享-->
	        <button v-if="assemble.left_time && !isShared && isFinshed" @click="handleInviteFriends">邀请好友</button>
          <!--已成团 - 被分享 -->
