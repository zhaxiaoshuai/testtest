  ...
  <div id="shipping-address">
    ...
    >
      ...
      />
	    <form ref="formHack">
        <van-cell-group>
	        <van-field @blur="handleIosResize" v-model="addressForm.name" label="收货人" clearable placeholder="请填写收货人"/>
	        <van-field @blur="handleIosResize" v-model="addressForm.mobile" label="手机号码" clearable placeholder="请填写手机号码" :maxlength="11"/>
	        <van-field @blur="handleIosResize" v-model="addressForm.addrs" label="所在地区" readonly icon="arrow" placeholder="请选择所在地区" @click.native="showAddressSelector = true"/>
	        <van-field @blur="handleIosResize" v-model="addressForm.addr" maxlength="50" label="详细地址" clearable placeholder="请填写详细地址"/>
	        <van-field @blur="handleIosResize" v-model="addressForm.ship_address_name" label="地址别名" clearable placeholder="请填写地址别名，如：公司" :maxlength="4"/>
      ...
      submitAddressForm() {
        ...
        if (!params.name) {
          ...
          params.def_addr = params.def_addr ? 1 : 0
	        Promise.all([
            addr_id ? API_Address.editAddress(addr_id, params) : API_Address.addAddress(params)
	        ]).then(() => {
