            ...
            <a :href="'/goods/' + goods.goods_id" class="goods-item-a" target="_blank">
              ...
              <div class="goods-item-price">
                ...
                <span class="goods-item-price-origin">
                  ...
                  <span style="display:inline-block;width:70px;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;" :title="goods.original_price | unitPrice"><i>¥</i>{{ goods.original_price | unitPrice }}</span>
                </span>
              </div>
            </a>
          </swiper-slide>
