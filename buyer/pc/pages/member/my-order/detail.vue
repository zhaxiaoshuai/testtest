        ...
        <div class="info-list">
          ...
          <template v-if="order.receipt_history && order.receipt_history.receipt_title">
            ...
            <dl>
              <dt>发票详情:</dt>
              <dd>
                <a :href="'/member/my-receipt/detail?history_id=' + order.receipt_history.history_id">查看详情</a>
              </dd>
            </dl>
          </template>
          ...
          <dl><dt>实付金额：</dt><dd style="font-size: 22px;" class="price">￥{{ (order.need_pay_money || 0) | unitPrice }}</dd></dl>
        </div>
      </div>
