    ...
    <div class="content">
      ...
      >
        ...
        <el-form-item label="组织机构代码：" prop="organization_code">
          <el-input v-model="authInfoForm.organization_code" :maxlength="50" clearable></el-input>
        </el-form-item>
        <el-form-item label="组织机构代码证电子版：" prop="code_img">
          <el-upload
            accept=".jpg,.png"
            :action="MixinUploadApi"
            :on-success="(res) => { authInfoForm.code_img = res.url, code_img_file = [{name: '组织机构代码证', url: res.url }] }"
            :on-remove="() => { authInfoForm.code_img = '' }"
            :limit="1"
            :file-list="code_img_file"
            list-type="picture">
            <el-button size="small" type="primary">点击上传</el-button>
            <div slot="tip" class="el-upload__tip">只能上传jpg/png文件</div>
          </el-upload>
